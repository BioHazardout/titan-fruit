...
const flow: { icon: IconName; title: string }[] = [
  { icon: "leaf", title: "Farm / Suppliers" },
  { icon: "truck", title: "Reception" },
  { icon: "search", title: "Quality Control" },
  { icon: "factory", title: "Primary Processing" },
  { icon: "package", title: "Packing" },
  { icon: "snow", title: "Cold Storage" },
  { icon: "globe", title: "International Logistics" },
  { icon: "user", title: "Customer" },
];

const stats: { icon: IconName; value: string; text: string }[] = [
  { icon: "pin", value: "20 KM", text: "From Callao port & airport" },
  ...
  return <main>
    <section className="relative isolate h-[calc(100svh-60px)] min-h-[590px] overflow-hidden bg-forest text-white lg:min-h-0">
      ...
      <div className="container relative flex h-full items-center py-12 sm:py-16"><div className="max-w-2xl">
        ...
        <p className="mt-5 max-w-lg text-base leading-7 text-white/80">Our own packing and primary processing facility is designed to ensure efficiency, food safety and the highest quality standards at every step of the process.</p>
