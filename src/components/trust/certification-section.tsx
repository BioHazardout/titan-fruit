...
export function CertificationSection({ image }: { image: string }) {
  return <section className="relative isolate overflow-hidden bg-[#021009] text-white">
    ...
    <div className="container relative py-12 sm:py-16">
      <div className="mx-auto grid max-w-4xl items-center gap-8 sm:gap-10 lg:grid-cols-[300px_1fr] lg:gap-14">
        <div className="relative mx-auto w-full max-w-[300px]"><div className="relative aspect-[.75/1] overflow-hidden rounded-2xl bg-white shadow-2xl"><Image src={image} alt="SENASA authorization document" fill sizes="300px" className="object-cover" /></div></div>
