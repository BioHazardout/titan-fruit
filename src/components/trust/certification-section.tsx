  ...
  return <section className="relative isolate overflow-hidden bg-[#021009] text-white">
    ...
    <div className="container relative py-12 sm:py-16">
      <div className="mx-auto grid max-w-4xl items-center gap-8 sm:gap-10 lg:grid-cols-[340px_1fr] lg:gap-14">
        <div className="relative mx-auto w-full max-w-[340px]"><div className="relative aspect-[524/375] overflow-hidden rounded-2xl border border-white/15 bg-white/[0.05] p-4 shadow-2xl backdrop-blur-sm"><Image src={image} alt="SENASA Peru" fill sizes="(max-width: 1024px) 340px, 340px" className="object-contain" /></div></div>
