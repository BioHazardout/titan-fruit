export const spanishCountryNames: Record<string, string> = {
  ...
  "Fiji": "Fiyi",
  "Finland": "Finlandia",
  "Fr. S. Antarctic Lands": "Tierras Australes Francesas",
  "France": "Francia",
  "Gabon": "Gabón",
  "Gambia": "Gambia",
  "Georgia": "Georgia",
...
export function getCountryDisplayName(rawName?: string, isSpanish = false): string {
  if (!rawName) return "";
  const trimmed = rawName.trim();
  if (trimmed.toLowerCase() === "country") return "";
  if (isSpanish) {
    return spanishCountryNames[trimmed] || trimmed;
  }
  if (trimmed === "United States of America") {
